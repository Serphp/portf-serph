...
export default function projectsConnection() {
  ...
  const loadMoreProjects = async () => {
    ...
    try {
      const { projectsConnection: newProjects } = await hygraph.request(
        queryPage,
        {
          first: 10,
          after: endCursor,
      ...
      <option value="otherOption">Mobile</option>
        ...
        {hasNextPage && (
          <>
            ...
            <button className="buttoned" onClick={loadMoreProjects}>
...
export function Projectsshort() {
  ...
  return (
    <>
      ...
      <div className="mb-3"></div>
      <Link to="/Proyectos">
        <div className="buttoned">Mas proyectos</div>
      </Link>
    </>
  );
}
